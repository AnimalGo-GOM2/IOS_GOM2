...
//  GOM2
//
//  Created by Kiwon on 2020/07/28.
//  Copyright © 2020 AnimalGo. All rights reserved.
//
...
class MainViewController: UIViewController {
    ...
    public func setPushID() {
        self.webView.evaluateJavaScript("localStorage.getItem(\"push_gom2_id\")") { (result, error) in
            ...
            if result as? String == nil {
                ...
                self.webView.evaluateJavaScript("localStorage.setItem(\"push_gom2_id\", '" + pushToken + "')") { (result, error) in
                }
            }
        }
    }
